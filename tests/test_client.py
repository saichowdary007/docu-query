...
from docuquery_ai.models.pydantic_models import QueryResponse
...
async def test_query(client, monkeypatch):
    ...
    response = await client_instance.query(question="What is the document about?", user_id="test_user")
