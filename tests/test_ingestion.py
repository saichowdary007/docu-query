...
async def test_ingest_file(ingestion_pipeline, monkeypatch):
    ...
    monkeypatch.setattr("docuquery_ai.ingestion.embedding.EmbeddingGenerator.generate_embeddings", mock_generate_embeddings)
    monkeypatch.setattr("docuquery_ai.ingestion.ner.NER.extract_entities", mock_extract_entities)
