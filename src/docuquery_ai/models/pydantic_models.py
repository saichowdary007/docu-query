...
class QueryResponse(BaseModel):
    answer: str
    type: str = Field(default="text", description="Type of response: 'text', 'list', 'table'")
    data: Optional[Any] = Field(default=None, description="Data for 'list' or 'table' type (e.g., list of strings, list of dicts for table)")
    columns: Optional[List[str]] = Field(default=None, description="Column headers if type is 'table'")
