...
from .services.vector_store import initialize_vector_store, add_documents_to_store, remove_documents_by_source
...
class DocumentQueryClient:
    ...
    def upload_document(self, 
        ...
        try:
            ...
            structure_type = source_path.suffix.lower().replace('.', '') if is_structured else None
    ...
    def query(self, 
             question: str, 
             user_id: str,
             file_ids: Optional[List[str]] = None) -> QueryResponse:
        """
